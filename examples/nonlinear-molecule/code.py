...
##For PIGS:
	#command_line = "python script_submission_analysis_MoRiBS.py -d "+str(DipoleMoment)+" -R 6.0 -N 2 -Block 10 -Pass 100 --ROTMOVE tau submission PIMC H2O H2O 0.0333333333"
	command_line = "python script_submission_analysis_MoRiBS.py -d "+str(DipoleMoment)+" -R 6.0 -N 2 -Block 10 -Pass 100 --ROTMOVE --preskip 10000 tau analysis PIMC H2O H2O 0.0333333333"
#-------------------------------#
##For PIGS:
