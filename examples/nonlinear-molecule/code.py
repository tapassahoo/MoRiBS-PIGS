...
for DipoleMoment in DList:
	...
	command_line = "python script_submission_analysis_MoRiBS.py -d "+str(DipoleMoment)+" -R 6.0 -N 2 -Block 100000 -Pass 50 --ROTMOVE tau analysis PIMC H2O H2O 0.0333333333"
#-------------------------------#
##For PIGS:
