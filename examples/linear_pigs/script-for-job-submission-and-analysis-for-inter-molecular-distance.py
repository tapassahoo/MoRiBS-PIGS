...
numbmolecules       = 3                                                            #change param2
numbblocks	       = 4000                                                         #change param3
numbbeads          = 101                                                          #change param4
temperature	       = 10.0                                                         #change param5
#status             = "submission"                                                #change param6
status             = "analysis"                                                   #change param7

nrange             = 76								                              #change param8
dRpt		       = 0.10                                                         #change param9
file1_name         = "temp"+str(temperature)+"blocks"+str(numbblocks)+"beads"+str(numbbeads)+"molecule"+str(numbmolecules)+str(molecule)+"e0vsRpt"                                                                                #change param10
file2_name         = "Angstrom"                                                   #change param11
argument2          = "Rpt"                                                        #change param12
value_min          = 2.50                                                         #change param13
...
if status == "submission":
	...
	file_input        = "Input-parameters-vs-Rpt-"+str(numbmolecules)+"-"+str(molecule)+"-fixed-beta"+str(beta)+"-beads"+str(numbbeads)+"-blocks"+str(numbblocks)+".txt"
	call(["rm", file_input])
...
#===============================================================================
if status == "analysis":
	file_output      = "Energy-vs-Rpt-"+str(numbmolecules)+"-"+str(molecule)+"-fixed-beta"+str(beta)+"-beads"+str(numbbeads)+"-blocks"+str(numbblocks)+".txt"  
	call(["rm", file_output])
...
for i in range(nrange):                                                  #change param13
	...
	if status == "submission":
		...
		fwrite.write(jobstring(argument2,Rpt))
