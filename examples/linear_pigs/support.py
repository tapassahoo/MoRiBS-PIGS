...
def GetrAndgFactor(molecule, RCOM, DipoleMoment):
	...
	DDFactor       = Units.AuToKelvin*(DipoleMomentAU*DipoleMomentAU)/(RCOMAU*RCOMAU*RCOMAU)
	printingmessage   = " DipoleMoment = "+str(DipoleMoment)+"; gFactor = " + str(gFactor)+ "; rFactor = "+str(rFactor)+"; Pre factor of Dipole-Dipole interaction potential in Kelvin = "+str(DDFactor)
	print(printingmessage)
