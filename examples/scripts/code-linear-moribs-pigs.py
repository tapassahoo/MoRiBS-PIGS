...
for rcom in rlist:
	space=" "
	string_layer1 = "linear-rotors"
	file_name1 = module_path+"submission_analysis.py"
	file_name2 = "script_submission_analysis.py"
	support.replace("NameOfOutputDirectory", string_layer1, file_name1, file_name2)
