...
plt.hist(data_plot, bins='auto', normed=1, color='green', alpha=0.75, edgecolor='black', label="PIGS/q-TIP4P/Rigid")
plt.ylabel(r'$\mathrm{\rho(r)}$',labelpad=8)
...
plt.subplots_adjust(top=0.99,bottom=0.13,left=0.09,right=0.99,hspace=0.0,wspace=0.0)
