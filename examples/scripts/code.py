...
stringName   = "linear-rotors"
fileName1    = "script_submission_analysis_MoRiBS.py"
fileName2    = "script_submission_analysis_MoRiBS-"+stringName+".py"
support.replace("NameOfOutputDirectory", stringName, fileName1, fileName2)
molecule     = "HF"
nMolecule    = 16
RCOM         = 10.05
...
for gFactor in gFactorList:
	...
	#command_line = "python "+fileName2+" -d "+str(output)+" -R "+str(RCOM)+" -N "+str(nMolecule)+" -Block 10000 -Pass 50 --ROTMOVE tau submission "+Simulation+" HF HF "+str(beta)
	...
	command_line = "python "+fileName2+" -d "+str(output)+" -R "+str(RCOM)+" -N "+str(nMolecule)+" -Block 10000 -Pass 50 --ROTMOVE tau analysis   "+Simulation+" HF HF "+str(beta)
	system(command_line)
#-------------------------------#
