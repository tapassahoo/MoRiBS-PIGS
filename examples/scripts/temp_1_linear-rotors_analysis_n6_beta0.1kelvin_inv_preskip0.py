...
source_code_dir_name = os.path.join("", "MoRiBS-PIGS")
output_file_dir_name = "linear-rotors"
if (method == "PIGS"):
	final_result_path = os.path.join(home, "", "final-pigs-outputs-for-plotting")
elif (method == "PIMC"):
	final_result_path = os.path.join(home, "", "final-pimc-outputs-for-plotting")
else:
	final_result_path = os.path.join(home, "", "final-ent-outputs-for-plotting")
