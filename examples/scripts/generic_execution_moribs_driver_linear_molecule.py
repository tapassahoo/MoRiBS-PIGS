...
if (job_type=="analysis"):
	temp_file_name = "temp_0_" + method + "_" + submission_root_dir_name + "_" + job_type + "_n" + str(numb_molecule) + rotor + "_" + parameter_name + str(parameter_value) + "kelvin_inverse_mcblock" + str(numb_block) + "_mcpass" +str(numb_pass) + "_preskip" + str(numb_preskip) +"_generic.py"
	temp_file_name1 = "temp_1_" + method + "_" + submission_root_dir_name + "_" + job_type + "_n" + str(numb_molecule) + rotor + "_" + parameter_name + str(parameter_value) + "kelvin_inverse_mcblock" + str(numb_block) + "_mcpass" +str(numb_pass) + "_preskip" + str(numb_preskip) +"_generic.py"

if (job_type=="submission"):
	temp_file_name = "temp_0_" + method + "_" + submission_root_dir_name + "_" + job_type + "_n" + str(numb_molecule) + rotor + "_" + parameter_name + str(parameter_value) + "kelvin_inverse_mcblock" + str(numb_block) + "_mcpass" +str(numb_pass) + "_generic.py"
	temp_file_name1 = "temp_1_" + method + "_" + submission_root_dir_name + "_" + job_type + "_n" + str(numb_molecule) + rotor + "_" + parameter_name + str(parameter_value) + "kelvin_inverse_mcblock" + str(numb_block) + "_mcpass" +str(numb_pass) + "_generic.py"
