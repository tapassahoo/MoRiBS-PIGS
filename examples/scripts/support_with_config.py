...
def jobstring_sbatch(RUNDIR, file_name, value, thread, folder_run_path, molecule, temperature, numbbeads, final_dir_in_work, dir_run_input_pimc, PPA1, user_name, out_dir, Restart1, dir_run_job,status_cagepot, dir_output):
	...
	ConfigCopy = "#"
	if (os.path.exists(dir_run_input_pimc+"/toberead-P"+str(numbbeads)+".xyz") == True):
		ConfigCopy = "cp "+dir_run_input_pimc+"/toberead-P"+str(numbbeads)+".xyz "+folder_run_path+"/readConf.xyz"
	print("")
	print("")
	print("")
...
time ./pimc 
%s
""" % (job_name, logpath, walltime, omp_thread, omp_thread, folder_run_path, output_dir, cagepot_cp, ConfigCopy, input_file, folder_run_path, file_rotdens, folder_run_path, "LatticeConfig.xyz", folder_run_path, folder_run_path, qmcinp, exe_file, folder_run_path, CommandForPPA, file_PPA, folder_run_path, CommandForMove)
