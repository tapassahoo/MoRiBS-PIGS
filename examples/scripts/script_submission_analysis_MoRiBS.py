...
#Request to change
#User should change the following 4 lines as developer already have explained in the README file. User could use "Yes" for status_rhomat for linear rotors only. If user wish to include cage potential, "No" flag must be turned into "Yes" by the user. 
...
#Request to change
#User should change the following 4 lines as developer already have explained in the README file.
user_name           = "tapas"                   
