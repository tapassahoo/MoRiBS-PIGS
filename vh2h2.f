...
c     variable potl, in units of wavenumbers.
      ...
      subroutine vh2h2(r, r1, r2, t1, t2, phi, potl)

      implicit real*8 (a-h, o-z)

      dimension v(4), vv(9), vij(3, 3, 4)
...
c     interpolated (r1, r2)-dependent coefficients.
      ...
      potl=v(1)*g000+v(2)*g202+v(3)*g022+v(4)*g224
...
c     long_range
     ...
     +                c5(3, 3), c6(3, 3, 4), c8(3, 3, 4), cten(3, 3)
      ...
      open (3, file='/home/tapas/Moribs-pigs/MoRiBS-PIMC/all_coefs')
      ...
      open (3, file='/home/tapas/Moribs-pigs/MoRiBS-PIMC/short_range')
      ...
      open (3, file='/home/tapas/Moribs-pigs/MoRiBS-PIMC/long_range')
