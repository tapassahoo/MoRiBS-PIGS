...
# CFLAGS for PIGS 
#CFLAGS =-I./sprng/include -I/usr/local/include -DUNITS -DPIGSROTORS -DPIGSROTORSIO -DLINEARROTORS -DLINEARROTORSIO -DTYPE1 -DGETR -DCHAINCONFIG -DDDCORR -DCHECKPOINT
#-DPROPOSED
#-DCAGEPOT
