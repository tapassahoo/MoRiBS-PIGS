...
# CFLAGS for PIGS 
CFLAGS =-I./sprng/include -I/usr/local/include -DTYPE1 -DCHAINCONFIG -DPIGSTYPE -DORDERPARA -DINSTANT
#-DORDERPARA -DINSTANT
# -DSHORTFORM -DONSITE
#-DPROPOSED
#-DCAGEPOT
...
pimcOBJS=mc_piqmc.o mc_estim.o mc_qworm.o mc_input.o mc_setup.o mc_poten.o mc_randg.o mc_utils.o rotden.o rotpro_sub.o rotred.o potred.o vcord.o vcalc.o initconf.o vspher.o caleng_tip4p_2005.o omprng.o rngstream.o vh2h2.o h2oc60.o hfc60.o plgndr.o 
