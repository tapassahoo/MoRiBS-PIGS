...
CFLAGS =-I./sprng/include -I/usr/local/include -DUNITS -DPIGSROTORS -DPIGSROTORSIO -DLINEARROTORS -DLINEARROTORSIO -DMODIFY -DDIPOLE -DGETDIPOLE -DROTENERGYESTIM -DENTANGLEMENT 
#-GETR
#-DINSTANT
#-DMODIFYSROTDENS
