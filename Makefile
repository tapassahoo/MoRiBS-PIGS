...
# CFLAGS for PIGS 
CFLAGS =-I./sprng/include -I/usr/local/include -DUNITS -DPIGSROTORS -DPIGSROTORSIO -DLINEARROTORS -DLINEARROTORSIO -DTYPE1 -DGETR -DCHAINCONFIG -DDDCORR -DCAGEPOT
#-DIOFILES #-DINSTANT -DBINARY 

# CFLAGS for ENTANGLEMENT
#CFLAGS =-I./sprng/include -I/usr/local/include -DUNITS -DPIGSROTORS -DPIGSROTORSIO -DLINEARROTORS -DLINEARROTORSIO -DENTANGLEMENT -DCHAINCONFIG -DBIPARTITION -DGETR -DMODIFYSROTDENS -DSWAPTOUNSWAP -DCAGEPOT
