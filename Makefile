...
CFLAGS =-I./sprng/include -I/usr/local/include -DUNITS -DPIGSROTORS -DPIGSROTORSIO -DLINEARROTORS -DLINEARROTORSIO -DGETR -DMODIFY -DDIPOLE -DGETDIPOLE -DROTENERGYESTIM #-DTESTCODE #-DENTANGLEMENT
