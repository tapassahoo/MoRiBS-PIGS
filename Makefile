...
#CFLAGS =-I./sprng/include -I/usr/local/include -DUNITS -DPIGSROTORS -DPIGSROTORSIO -DLINEARROTORS -DLINEARROTORSIO -DGETR -DMODIFY -DDIPOLE -DGETDIPOLE -DROTENERGYESTIM -DINSTANT
#-DSTEPCOST
#-DMODIFYSROTDENS

CFLAGS =-I./sprng/include -I/usr/local/include -DUNITS -DPIGSROTORS -DPIGSROTORSIO -DLINEARROTORS -DLINEARROTORSIO -DGETR -DMODIFY -DDIPOLE -DGETDIPOLE -DROTENERGYESTIM -DENTANGLEMENT -DINSTANT -DPOTZERO
