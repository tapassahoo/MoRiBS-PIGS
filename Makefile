...
#CFLAGS =-I./sprng/include -I/usr/local/include -DUNITS -DPIGSROTORS -DPIGSROTORSIO -DLINEARROTORS -DLINEARROTORSIO -DENTANGLEMENT -DCHAINCONFIG -DBIPARTITION  -DGETR -DREGULARPATH -DPOTZERO -DINSTANT -DIOFILES -DMODIFYSROTDENS
