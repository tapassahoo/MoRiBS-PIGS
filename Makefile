...
# CFLAGS for PIGS 
#CFLAGS =-I./sprng/include -I/usr/local/include -DUNITS -DPIGSROTORS -DPIGSROTORSIO -DLINEARROTORS -DLINEARROTORSIO -DDIPOLE -DROTENERGYESTIM 
#-GETR
#-DINSTANT
#-DMODIFYSROTDENS

# CFLAGS for ENTANGLEMENT
CFLAGS =-I./sprng/include -I/usr/local/include -DUNITS -DPIGSROTORS -DPIGSROTORSIO -DLINEARROTORS -DLINEARROTORSIO -DENTANGLEMENT -DCHAINCONFIG -DGETR -DTEST -DREGULARPATH -DPOTZERO -DINSTANT -DIOFILES -DMODIFYSROTDENS
#-DINSTANT
#-DBROKENPATH
#-DMODIFYSROTDENS
