...
c      parameter (ncost2 = 101)
c      parameter (nphi2 = 361)
c      dimension distrb(ncost2*nphi2)
c
c      character argum*30
c
...
c      cost3 = 0.0d0
c      phi3 = 0.0d0
c      call propos(cost1, phi1, cost3, phi3, temprt, nslice,
c     & bconst, iodevn, distrb)
c      open(7,file='linden.out',status='unknown')
c      sum1 = 0.0d0
c      do ii = 1, ncost2*nphi2
c        write(7,'(1p,7(1x,E15.8))')distrb(ii)
c        sum1 = sum1 + distrb(ii)
c      enddo
