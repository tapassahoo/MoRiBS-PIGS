c     ==================================================
      subroutine calengy(com, Eulang, E_H2OC60)
c     ==================================================
c     Initially:
...
c     ROwf, RH1wf, RH2wf, RCwf put as data   
      ...
      dimension ROwf(3), RH1wf(3), RH2wf(3),fact(3), 
...
c      write(44,72) com(1:3), E_H2OC60     
   71 format(9F12.6,6F22.4)
   72 format(3F12.6,6F22.4)
