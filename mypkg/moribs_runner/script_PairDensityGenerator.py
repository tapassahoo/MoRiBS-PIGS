...
parser = argparse.ArgumentParser(
	description="It is a script file, written in Python, used to submit jobs in a queue as well as analyze output data files which are generated by the jobs submitted earlier. Note: Module support.py consists of many functions and it is not permitted to modify without consulting the developer - Dr. Tapas Sahoo. User can easily modify module inputFile.py to generate lists of beads (see Getbeads function), step lengths for rotational and translational motions, and levels for Bisection move (see class GetStepAndLevel) as needed."
)
parser.add_argument(
	"-d",
	"--DipoleMoment",
	type=float,
	help="Dipole Moment of a bipolar molecule in Debye. It is a float.",
	default=0.0,
)
parser.add_argument(
	"-R", "--Rpt", type=float, help="Inter molecular spacing. It is a float.", default=1.0
)
parser.add_argument(
	"variable",
	help="Name of a variable: either beta or tau. It must be a string.",
	choices=["tau", "beta"],
)
