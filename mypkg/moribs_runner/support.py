...
#---------------------------------------------------------------------------#
		'''
				name_layer1CP		= "vs-number-of-"+str(self.molecular_system)+"-fixed-"+self.parameter_name+str(self.parameter)+"Kinv-Blocks"+str(self.numb_block)
				...
				name_layer1CONV	 += "-Passes"+str(self.numb_pass)+"-System"+str(self.numb_molecule)+str(self.molecular_system)+add1+"-preskip"+str(self.preskip)+"-postskip"+str(self.postskip)
				...
				'''
#
		name_layer1GFAC = "vs-gFactor-of-" + str(self.molecular_system) + "-fixed-" + self.parameter_name + str(
			self.parameter_value) + "Kinv-numb_bead" + str(self.var) + "-Blocks" + str(self.numb_block)
		...
		name_layer1GFACFit = "vs-gFactor-of-" + \
			str(self.molecular_system) + "-fixed-" + self.parameter_name + \
			str(self.parameter_value) + "Kinv-Blocks" + str(self.numb_block)
		name_layer1GFACFit += "-Passes" + \
			str(self.numb_pass) + "-preskip" + str(self.preskip) + \
			"-postskip" + str(self.postskip) + add2 + "-Fit"
#
		name_layer1RFAC = "vs-RFactor-of-" + str(self.molecular_system) + "-fixed-" + self.parameter_name + str(
			self.parameter_value) + "Kinv-numb_bead" + str(self.var) + "-Blocks" + str(self.numb_block)
		name_layer1RFAC += "-Passes" + \
			str(self.numb_pass) + "-preskip" + str(self.preskip) + \
			"-postskip" + str(self.postskip) + add2
		name_layer1MM = "vs-" + \
			str(variable_name) + "-fixed-" + \
			self.parameter_name + str(self.parameter_value) + "Kinv"
		name_layer1MM += "-System" + \
			str(self.numb_molecule) + str(self.molecular_system) + add1
		...
		name_layer1COMBO += "-Passes" + str(self.numb_pass) + "-System" + str(self.numb_molecule) + str(
			self.molecular_system) + add1 + "-preskip" + str(self.preskip) + "-postskip" + str(self.postskip)
...
#
		...
		if (self.method == "ENT"):
			name_layer1RT = "vs-" + str(variable_name) + "-fixed-" + self.parameter_name + str(
				self.parameter_value) + "Kinv-Blocks" + str(self.numb_block)
			name_layer1RT += "-Passes" + str(self.numb_pass) + "-System" + str(self.numb_molecule) + str(
				self.molecular_system) + "-preskip" + str(self.preskip) + "-postskip" + str(self.postskip) + add2
